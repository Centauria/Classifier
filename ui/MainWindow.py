...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.files_tableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerItem)
        ...
        self.classifier_property_pushButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.classifier_property_pushButton.setMinimumSize(QtCore.QSize(75, 0))
        self.classifier_property_pushButton.setObjectName("classifier_property_pushButton")
        self.horizontalLayout_3.addWidget(self.classifier_property_pushButton, 0, QtCore.Qt.AlignRight)
        self.create_classifier_pushButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.create_classifier_pushButton.setMinimumSize(QtCore.QSize(75, 0))
        self.create_classifier_pushButton.setObjectName("create_classifier_pushButton")
        self.horizontalLayout_3.addWidget(self.create_classifier_pushButton, 0, QtCore.Qt.AlignRight)
        self.show_test_pushButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        ...
        self.options_tableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerItem)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "分类器"))
        self.classifier_comboBox.setItemText(0, _translate("MainWindow", "位势函数"))
        self.classifier_property_pushButton.setText(_translate("MainWindow", "属性"))
        self.create_classifier_pushButton.setText(_translate("MainWindow", "构建分类器"))
        self.show_test_pushButton.setText(_translate("MainWindow", "显示分类结果"))
        ...
        self.label_2.setText(_translate("MainWindow", "可视化选项"))
        self.train_checkBox.setText(_translate("MainWindow", "训练集数据"))
        self.test_checkBox.setText(_translate("MainWindow", "测试集数据"))
        self.result_checkBox.setText(_translate("MainWindow", "分类结果"))
        ...
        self.menuset_current_item_as.setTitle(_translate("MainWindow", "设置当前项为"))
        self.menuset_current_file_as.setTitle(_translate("MainWindow", "设置当前文件为"))
        ...
        self.actionset_Y.setText(_translate("MainWindow", "设置当前项为y轴"))
        self.actionset_C.setText(_translate("MainWindow", "设置当前项为类别"))
        self.actionset_X_2.setText(_translate("MainWindow", "set_X"))
        self.actionset_Y_2.setText(_translate("MainWindow", "set_Y"))
        self.actionx.setText(_translate("MainWindow", "x"))
        self.actionset_x.setText(_translate("MainWindow", "x轴"))
        self.actionset_x.setShortcut(_translate("MainWindow", "Ctrl+Alt+X"))
        self.actionset_y.setText(_translate("MainWindow", "y轴"))
        self.actionset_y.setShortcut(_translate("MainWindow", "Ctrl+Alt+Y"))
        self.actionset_c.setText(_translate("MainWindow", "类别"))
        self.actionset_c.setShortcut(_translate("MainWindow", "Ctrl+Alt+C"))
        self.actionset_train.setText(_translate("MainWindow", "训练集"))
        self.actionset_test.setText(_translate("MainWindow", "测试集"))
